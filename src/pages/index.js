...
const Component = () => {
  ...
  return (
    <Layout title='Melchor Dominguez'>
      ...
      <h2>
        Software Engineer with multiple years of experience designing scalable
				API platforms and automated financial systems in high compliance environments.
				Leveraging a dual background in Applied Mathematics and Computer Science, with
